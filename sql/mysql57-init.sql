...
CREATE TABLE IF NOT EXISTS `db_consultation_service_feedback` (
  ...
  `doctor_handle_status` tinyint(1) NOT NULL DEFAULT 0,
  `doctor_handle_remark` varchar(1000) DEFAULT NULL,
  `doctor_handle_account_id` int DEFAULT NULL,
  `doctor_handle_doctor_id` int DEFAULT NULL,
  `doctor_handle_doctor_name` varchar(50) DEFAULT NULL,
  `doctor_handle_time` datetime DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  ...
  KEY `idx_consultation_service_feedback_doctor_handle` (`doctor_id`, `doctor_handle_status`, `update_time`),
...
CREATE TABLE IF NOT EXISTS `db_doctor_message_ai_log` (
  ...
  `regenerate_field` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `db_doctor_form_ai_log` (
  ...
  `risk_flags_json` varchar(500) DEFAULT NULL,
  `draft_summary` varchar(255) DEFAULT NULL,
  `draft_context_used` tinyint(1) NOT NULL DEFAULT 0,
  `rewrite_requirement` varchar(500) DEFAULT NULL,
